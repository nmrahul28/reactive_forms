...
export class FormsComponent implements OnInit {
  ...
  ngOnInit() {
    this.user_data =new FormGroup({
      ...
      address:new FormGroup({
        ...
        zip:new FormControl('',Validators.compose([Validators.required, Validators.maxLength(6), Validators.minLength(6),Validators.pattern('[0-9]+')]))
      })
      });

  }
  get control(){
    return this.user_data.controls;
  }
  ...
  onSubmit() {
    ...
    alert(JSON.stringify(this.user_data.value));
  }
